...
const CartWidget = () => {
  ...
  return (
    <div className="h-2 my-1 mr-32 flex hover:text-yellow-400">
        <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" fill="white" className="hover:fill-yellow-400">
